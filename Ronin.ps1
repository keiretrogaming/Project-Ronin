# ==============================================================================
# PROJECT RONIN // SHOGUN EDITION (DEFINITIVE MONOLITH)
# ==============================================================================
...
$WingetMap = @{
    ...
    $window.Add_Closed({ $sync.Running = $false; $runspace.Close(); $runspace.Dispose(); Stop-Transcript -ErrorAction SilentlyContinue })
